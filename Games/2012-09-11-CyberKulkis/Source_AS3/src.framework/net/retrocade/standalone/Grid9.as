package net.retrocade.standalone{
     ...
     */
    public class Grid9 extends rSprite{
        /****************************************************************************************************************/
        /**                                                                                           STATIC FUNCTIONS  */
        /****************************************************************************************************************/
        ...
        public static function getGrid(name:String, dontScale:Boolean = false):Grid9{
            var g:Grid9 = new Grid9(dontScale);
            var c:Grid9 = _gridLibrary[name];
        ...
        public function Grid9(dontScale:Boolean = false):void{
            if (_dontScale = dontScale)
                _matrix = new Matrix();
