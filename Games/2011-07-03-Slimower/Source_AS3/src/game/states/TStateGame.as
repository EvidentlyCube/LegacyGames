package game.states {
	...
	public class TStateGame extends RetrocamelStateBase {
		...
		override public function update():void {
			var isPauseOpening: Boolean = RetrocamelInputManager.isKeyHit(KeyConst.ESCAPE) || RetrocamelInputManager.isKeyHit(KeyConst.O)
			if (isPauseOpening && Level.player && Score.timer.get() > 0) {
