package game.global {
	...
	public class Game {
		...
		[Embed(source="../../../assets/sfx/blaster.mp3")] public static var _blaster_:Class;
		[Embed(source="../../../assets/sfx/blob_hit.mp3")] public static var _blob_hit_:Class;
		[Embed(source="../../../assets/sfx/blob_kill.mp3")] public static var _blob_kill_:Class;
		[Embed(source="../../../assets/sfx/coin.mp3")] public static var _coin_:Class;
		[Embed(source="../../../assets/sfx/dead.mp3")] public static var _dead_:Class;
		[Embed(source="../../../assets/sfx/step_ground.mp3")] public static var _footstep_:Class;
		[Embed(source="../../../assets/sfx/groan.mp3")] public static var _groan_:Class;
		[Embed(source="../../../assets/sfx/jump.mp3")] public static var _jump_:Class;

		[Embed(source="../../../assets/music/synthmania/synthmania11_wojciech_panufnik.mp3")] public static var _music_:Class;
