package com.mauft
{
   ...
   public class Control
   {
      ...
      {
         super();
         new Error("Can\'t instantiate Control object - please use static methods only!");
      }
      ...
      {
         return keyHolds[param1];
      }
      
      public static function isKeyHit(param1:int) : Boolean
      {
         if(!_singleHits)
         {
            return keyHits[param1];
         }
         if(keyHits[param1])
         {
            keyHits[param1] = false;
            return true;
         }
         return false;
      }
      
      public static function set singleHits(param1:Boolean) : void
      {
         _singleHits = param1;
      }
      
      public static function get singleHits() : Boolean
      {
         return _singleHits;
      }
      ...
      {
         keyHolds[param1.keyCode] = true;
         keyHits[param1.keyCode] = true;
      }
      
      private static function keyUp(param1:KeyboardEvent) : void
      {
         keyHolds[param1.keyCode] = false;
         keyHits[param1.keyCode] = false;
      }
   }
}
