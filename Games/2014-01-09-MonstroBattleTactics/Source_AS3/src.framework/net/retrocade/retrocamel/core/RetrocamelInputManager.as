...
package net.retrocade.retrocamel.core{
    ...
    public class RetrocamelInputManager{
        ...
        private static var _isRightMouseDown             :Boolean = false;
...
// ::::::::::::::::::::::::::::::::::::::::::::::::
         ...
         * Resets all key states to not hit / held
         */
        public static function flushKey(keyCode:uint):void {
			_keyDowns[keyCode] = _keyHits[keyCode] = false;
		}
        /**
        ...
        private static function onRightMouseDown(e:MouseEvent):void{
            ...
            _isCtrlDown  = e.ctrlKey;
            _isShiftDown = e.shiftKey;
			_isRightMouseDown = e.buttonDown;
            _mouseX      = e.stageX;
            _mouseY      = e.stageY;
