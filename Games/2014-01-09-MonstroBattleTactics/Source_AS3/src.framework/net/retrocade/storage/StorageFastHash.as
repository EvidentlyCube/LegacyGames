...
package net.retrocade.storage{
    ...
    public class StorageFastHash implements IStorage{
        retrocamel_int  var _storageObject:Object;
        retrocamel_int  var _validationObject:Object;
        ...
        public function StorageFastHash(ioHandler:IStorageIOHandler, cryptoKey:String, salt:String, scrambleKey:int):void{
            _l("new StorageFastHash()");
        ...
        private  function verifyIntegrity(key:String):void{
            if (_storageObject[key] !== _validationObject[key]){
...
//            save();
        ...
        private  function regenerateHash():void{
            _validationObject = {};
			for (var property:String in _storageObject){
				if (_storageObject.hasOwnProperty(property)){
					_validationObject[property] = _storageObject[property];
				}
			}
        }

        private  function regenerateKey(key:String):void{
            _validationObject[key] = _storageObject[key];
        }
    }
}