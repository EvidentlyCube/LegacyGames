...
package starling.textures
{
    ...
    public class TextureAtlas
    {
        ...
        private var _mTextureInfos:Dictionary;

		public function get texturesInfos():Dictionary {
			return _mTextureInfos;
		}
		...
		public function parseAtlasJson(atlasJson:Object):void{
			for each(var frame:Object in atlasJson.frames){
				addRegion(
					frame.filename,
        ...
        {
            var info:TextureInfo = _mTextureInfos[name];
        ...
        {
            return _mTextureInfos.hasOwnProperty(name);
        }
        ...
        public function getNames(prefix:String="", result:Vector.<String>=null):Vector.<String>
        {
            ...
            for (var name:String in _mTextureInfos)
        ...
        {
            _mTextureInfos[name] = new TextureInfo(region, frame, rotated);
        }
        
        /** Removes a region with a certain name. */
        public function removeRegion(name:String):void
        {
            delete _mTextureInfos[name];
        }
