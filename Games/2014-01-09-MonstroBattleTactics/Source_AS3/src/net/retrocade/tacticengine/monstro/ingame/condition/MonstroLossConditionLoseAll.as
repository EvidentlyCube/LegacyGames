...
package net.retrocade.tacticengine.monstro.ingame.condition {
    ...
    public class MonstroLossConditionLoseAll implements IMonstroCondition {
        private var _targets:Vector.<MonstroEntity>;

        public function MonstroLossConditionLoseAll(field:MonstroField) {
        ...
        public function get type():String {
            return MonstroConditionFactory.LOSE_ALL;
        }
    }
}
