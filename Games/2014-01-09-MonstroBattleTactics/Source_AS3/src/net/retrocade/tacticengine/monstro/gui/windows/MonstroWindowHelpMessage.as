...
package net.retrocade.tacticengine.monstro.gui.windows {
	...
	public class MonstroWindowHelpMessage extends RetrocamelWindowStarling {
		public static function showWindow(header:String, text:String, width:uint = 500, pauseGame:Boolean = true):MonstroWindowHelpMessage {
			var instance:MonstroWindowHelpMessage = injectCreate(MonstroWindowHelpMessage);
		...
		private function initCreateObjects():void {
			...
			_text = new TextField(windowWidth - 180, 500, textToShow, MonstroConsts.FONT_NATIVE, 24, 0x382010);
