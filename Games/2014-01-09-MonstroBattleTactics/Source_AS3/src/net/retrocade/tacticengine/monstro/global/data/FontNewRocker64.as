...
package net.retrocade.tacticengine.monstro.global.data {
    ...
    public class FontNewRocker64 extends BitmapFont{
        [Embed(source="/../assets/gfx/fonts/NewRocker_64.fnt", mimeType="application/octet-stream")] private static const font_definition:Class;
        [Embed(source="/../assets/gfx/fonts/NewRocker_64_0.png")] private static const font_png:Class;

		private static var _texture:Texture;

        public function FontNewRocker64() {
