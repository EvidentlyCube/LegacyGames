...
package net.retrocade.tacticengine.monstro.global.data {
	...
	public class FontEboracum48 extends BitmapFont{
        [Embed(source="/../assets/gfx/fonts/eboracum_48.fnt", mimeType="application/octet-stream")] private static const font_definition:Class;
        [Embed(source="/../assets/gfx/fonts/eboracum_48_0.png")] private static const font_png:Class;

		private static var _texture:Texture;

        public function FontEboracum48() {
