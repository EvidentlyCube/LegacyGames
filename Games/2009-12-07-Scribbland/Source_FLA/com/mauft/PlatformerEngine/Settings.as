...
package com.mauft.PlatformerEngine{
	...
	final public class Settings{
		public static const SCREEN_WIDTH:uint=800					//Just type the game screen width here, it does not neccesirily have to be the size of flash app (but can't be bigger
		...
		public static const LEVEL_WIDTH:uint=27					//Maximum level width in tiles, best if not too big for speed reasons
		...
		public static const PLAYER_ACCELERATION:Number=0.5			//Player's acceleration in PPS
		public static const PLAYER_FRICTION:Number=0.5				//Player's speed of breaking when not running in PPS
		public static const PLAYER_BRAKING:Number=0.5				//Player's speed of running when trying to quickly change direction (in other words, if you run right and start to hold left, how quickly will you brake) in PPS
		...
		public static const PLAYER_JUMP:Number=-5.3				//Player's vertical speed when jumping
		...
		public static const GRAVITY:Number=0.2					//Power of the gravity in PPS
		public static const PLAYER_GRAVITY:Number=0.2			//Power of the gravity for player in PPS
