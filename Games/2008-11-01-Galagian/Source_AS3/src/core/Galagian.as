package core {
	...
	public class Galagian extends Sprite implements IGalagian {
		[Embed("/../assets/gfx/TitleScreen.png")]
		private var assetTitleScreen:Class;
		[Embed("/../assets/gfx/GameOver.png")]
		...
		public static var cheatNoAsteroids: Boolean = false;
		...
		public function Galagian() {
			...
			CheatCodes.AddCheat(
				...
				function(): void {
					Sfx.sound("dmd");
					Sfx.sound("dmd");
					cheatNoAsteroids = !cheatNoAsteroids;
				}
			);
		}
		...
		public function Step(e:Event):void {
			...
			if (pauser.alpha == 0 && titleScreenBitmap.alpha == 0 && gameOverContainer.alpha == 0) {
				if (cheatNoAsteroids === false && Math.random() < 0.005 && List.Enemies.length > TAsteroid.howMany && Hud.instance.messer == 0) {
