package Classes.Interactivers
{
	...
	public class TIceCrateSteel extends TObject{
		[Embed("../../../assets/gfx/gameplay/IceCrateSteel.png")] public static var g_0:Class;
		public function TIceCrateSteel(_x:uint,_y:uint){
				x=_x
			y=_y
