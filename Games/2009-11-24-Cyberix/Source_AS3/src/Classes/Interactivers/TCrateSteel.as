package Classes.Interactivers
{
	...
	public class TCrateSteel extends TObject{
		[Embed("../../../assets/gfx/gameplay/CrateSteel.png")] public static var g_0:Class;
		public function TCrateSteel(_x:uint,_y:uint){
			x=_x
			y=_y
