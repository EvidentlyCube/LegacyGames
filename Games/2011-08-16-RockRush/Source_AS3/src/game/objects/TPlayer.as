package game.objects {
	...
	public class TPlayer extends TGameObject {
		...
		public static var cheatTriggerDiamondUpdate:Boolean = false;
		public static var cheatTeleport: Boolean = false;
		...
		override public function update():void {
			if (cheatTriggerDiamondUpdate) {
				RetrocamelEventsQueue.add(C.EVENT_DIAMOND_COLLECTED);
				cheatTriggerDiamondUpdate = false;
			}
			...
			if (RetrocamelInputManager.isShiftDown() && RetrocamelInputManager.isMouseHit() && cheatTeleport) {
				removeSelf();
		...
		protected function moveOrTouch(tx:int, ty:int):void {
			if (RetrocamelSimpleSave.read('firstPlay', true)) {
				RetrocamelSimpleSave.writeFlush('firstPlay', false);
