package game.objects {
	...
	public class TTileExit extends TGameObject {
		...
		public static var cheatComplete: Boolean = false;
		...
		override public function update():void {
			...
			if (Level.instance.completed) {
				if (!_playerEntered) {
					...
					if (RetrocamelInputManager.isKeyDown(Game.keyGrab)) {
			...
			if (_frame == 0 && Score.diamondsGot >= Score.diamondsToGet && RetrocamelEventsQueue.occured(C.EVENT_DIAMOND_COLLECTED)) {
