package game.global {
	...
	public class Options extends Sprite {
		[Embed(source='/../assets/gfx/global/music.png')]
		private var _gfx_music_:Class;
		[Embed(source='/../assets/gfx/global/sfx.png')]
		...
		private function onKeyChangePress(e:KeyboardEvent):void {
			...
			RetrocamelSimpleSave.writeFlush('opt' + _nowChanging.data.keyName, e.keyCode);
		...
		private function changedMusic(value:Number):void {
			...
			RetrocamelSimpleSave.writeFlush('optVolumeMusic', value);
		}

		private function changedSfx(value:Number):void {
			RetrocamelSoundManager.soundVolume = value;
			RetrocamelSimpleSave.writeFlush('optVolumeSound', value);
		}
	}
}