...
package game.global.pre {
	...
	public class PreData {
		...
		[Embed(source='/../assets/i18n/en.txt', mimeType='application/octet-stream')]
		private static var _lang_en_core_:Class;
		[Embed(source='/../assets/i18n/pl.txt', mimeType='application/octet-stream')]
		private static var _lang_pl_core_:Class;

		[Embed(source='/../assets/i18n/en_regular.txt', mimeType='application/octet-stream')] private static var _lang_en_regular_:Class;
		[Embed(source='/../assets/i18n/pl_regular.txt', mimeType='application/octet-stream')] private static var _lang_pl_regular_:Class;
		[Embed(source='/../assets/i18n/en_classic_i.txt', mimeType='application/octet-stream')] private static var _lang_en_classic_i_:Class;
		[Embed(source='/../assets/i18n/pl_classic_i.txt', mimeType='application/octet-stream')] private static var _lang_pl_classic_i_:Class;
		[Embed(source='/../assets/i18n/en_classic_ii.txt', mimeType='application/octet-stream')] private static var _lang_en_classic_ii_:Class;
		[Embed(source='/../assets/i18n/pl_classic_ii.txt', mimeType='application/octet-stream')] private static var _lang_pl_classic_ii_:Class;
		[Embed(source='/../assets/i18n/en_classic_iii.txt', mimeType='application/octet-stream')] private static var _lang_en_classic_iii_:Class;
		[Embed(source='/../assets/i18n/pl_classic_iii.txt', mimeType='application/octet-stream')] private static var _lang_pl_classic_iii_:Class;
		[Embed(source='/../assets/i18n/en_undervaults.txt', mimeType='application/octet-stream')] private static var _lang_en_undervaults_:Class;
		[Embed(source='/../assets/i18n/pl_undervaults.txt', mimeType='application/octet-stream')] private static var _lang_pl_undervaults_:Class;

		[Embed(source="/../assets/gfx/fonts/font.png", mimeType="image/png")] private static var _font_:Class;
		[Embed(source="/../assets/gfx/fonts/c64font.png", mimeType="image/png")] private static var _font_c64_:Class;

		[Embed(source='/../assets/gfx/bgs/tooltipSystem.png')] private static var _tooltipSystem:Class;
		[Embed(source='/../assets/gfx/bgs/buttonSystem.png')] private static var _buttonBgSystem_:Class;
		[Embed(source='/../assets/gfx/bgs/windowSystem.png')] private static var _windowSystem_:Class;
		...
		public static function loadLanguageFiles():void {
			...
			RetrocamelLocaleParserRetrocadeProperties.parse(_lang_en_regular_, 'en');
			RetrocamelLocaleParserRetrocadeProperties.parse(_lang_pl_regular_, 'pl');
			RetrocamelLocaleParserRetrocadeProperties.parse(_lang_en_classic_i_, 'en');
			RetrocamelLocaleParserRetrocadeProperties.parse(_lang_pl_classic_i_, 'pl');
			RetrocamelLocaleParserRetrocadeProperties.parse(_lang_en_classic_ii_, 'en');
			RetrocamelLocaleParserRetrocadeProperties.parse(_lang_pl_classic_ii_, 'pl');
			RetrocamelLocaleParserRetrocadeProperties.parse(_lang_en_classic_iii_, 'en');
			RetrocamelLocaleParserRetrocadeProperties.parse(_lang_pl_classic_iii_, 'pl');
			RetrocamelLocaleParserRetrocadeProperties.parse(_lang_en_undervaults_, 'en');
			RetrocamelLocaleParserRetrocadeProperties.parse(_lang_pl_undervaults_, 'pl');
		}
