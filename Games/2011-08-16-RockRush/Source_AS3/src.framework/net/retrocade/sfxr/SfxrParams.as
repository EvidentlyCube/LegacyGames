	...
	public class SfxrParams {
		...
		public function get waveType():uint {
			return _waveType;
				...
				public function set waveType(value:uint):void {
			_waveType = value > 3 ? 0 : value;
			paramsDirty = true;
		}    // Length of the volume envelope attack (0 to 1)
		
private var _masterVolume:Number = 0.5;    // Length of the volume envelope sustain (0 to 1)
		...
		public function set masterVolume(value:Number):void {
			_masterVolume = clamp1(value);
			paramsDirty = true;
		}    // Length of the volume envelope decay (yes, I know it's called release) (0 to 1)

		private var _attackTime:Number = 0.0;    // Base note of the sound (0 to 1)
		...
		public function get attackTime():Number {
			...
			_attackTime = clamp1(value);
			paramsDirty = true;
		}    // Slides the note up or down (-1 to 1)
		
private var _sustainTime:Number = 0.0;    // Accelerates the slide (-1 to 1)
		...
		public function set sustainTime(value:Number):void {
			_sustainTime = value;
			paramsDirty = true;
		}    // Speed of the vibrato effect (i.e. frequency) (0 to 1)

		private var _sustainPunch:Number = 0.0;    // Shift in note, either up or down (-1 to 1)
		...
		public function get sustainPunch():Number {
			return _sustainPunch;
				...
				public function set sustainPunch(value:Number):void {
			_sustainPunch = clamp1(value);
			paramsDirty = true;
		}    // Controls the ratio between the up and down states of the square wave, changing the tibre (0 to 1)
		
private var _decayTime:Number = 0.0;    // Sweeps the duty up or down (-1 to 1)
		...
		public function get decayTime():Number {
			...
			_decayTime = clamp1(value);
			paramsDirty = true;
		}    // Offsets a second copy of the wave by a small phase, changing the tibre (-1 to 1)
		
private var _startFrequency:Number = 0.0;    // Sweeps the phase up or down (-1 to 1)
		...
		public function set startFrequency(value:Number):void {
			_startFrequency = clamp1(value);
			paramsDirty = true;
		}    // Sweeps the low-pass cutoff up or down (-1 to 1)
		
private var _minFrequency:Number = 0.0;    // Changes the attenuation rate for the low-pass filter, changing the timbre (0 to 1)
		...
		public function set minFrequency(value:Number):void {
			_minFrequency = clamp1(value);
			paramsDirty = true;
...
private var _deltaSlide:Number = 0.0;
		...
		public function set deltaSlide(value:Number):void {
			_deltaSlide = clamp2(value);
			paramsDirty = true;
		}

private var _vibratoDepth:Number = 0.0;
		...
		public function set vibratoDepth(value:Number):void {
			_vibratoDepth = clamp1(value);
			paramsDirty = true;
		}

private var _vibratoSpeed:Number = 0.0;
		...
		public function set vibratoSpeed(value:Number):void {
			_vibratoSpeed = clamp1(value);
			paramsDirty = true;
		}

private var _changeAmount:Number = 0.0;
		...
		public function set changeAmount(value:Number):void {
			_changeAmount = clamp2(value);
			paramsDirty = true;
		}

private var _changeSpeed:Number = 0.0;
		...
		public function set changeSpeed(value:Number):void {
			_changeSpeed = clamp1(value);
			paramsDirty = true;
		}

private var _squareDuty:Number = 0.0;
		...
		public function set squareDuty(value:Number):void {
			_squareDuty = clamp1(value);
			paramsDirty = true;
		}

private var _dutySweep:Number = 0.0;
		...
		public function set dutySweep(value:Number):void {
			_dutySweep = clamp2(value);
			paramsDirty = true;
		}

private var _repeatSpeed:Number = 0.0;
		...
		public function set repeatSpeed(value:Number):void {
			_repeatSpeed = clamp1(value);
			paramsDirty = true;
		}

private var _phaserOffset:Number = 0.0;
		...
		public function set phaserOffset(value:Number):void {
			_phaserOffset = clamp2(value);
			paramsDirty = true;
		}

private var _phaserSweep:Number = 0.0;
		...
		public function set phaserSweep(value:Number):void {
			_phaserSweep = clamp2(value);
			paramsDirty = true;
		}

private var _lpFilterCutoff:Number = 0.0;
		...
		public function set lpFilterCutoff(value:Number):void {
			_lpFilterCutoff = clamp1(value);
			paramsDirty = true;
		}

private var _lpFilterCutoffSweep:Number = 0.0;
		...
		public function set lpFilterCutoffSweep(value:Number):void {
			_lpFilterCutoffSweep = clamp2(value);
			paramsDirty = true;
		}

private var _lpFilterResonance:Number = 0.0;
		...
		public function set lpFilterResonance(value:Number):void {
			_lpFilterResonance = clamp1(value);
			paramsDirty = true;
		}

private var _hpFilterCutoff:Number = 0.0;
		...
		public function set hpFilterCutoff(value:Number):void {
			_hpFilterCutoff = clamp1(value);
			paramsDirty = true;
		}

private var _hpFilterCutoffSweep:Number = 0.0;
		...
		public function set hpFilterCutoffSweep(value:Number):void {
			_hpFilterCutoffSweep = clamp2(value);
			paramsDirty = true;
		}
		 ...
		 */
		private function clamp1(value:Number):Number {
		 ...
		 */
		private function clamp2(value:Number):Number {
