package game.objects.effects{
    ...
    public class TEffectDebris extends TEffectParticles{
        private static var _frames:Array = [
                rGfx.getBDExt(Gfx.CLASS_EFFECTS, 44, 44, 4, 4),
                rGfx.getBDExt(Gfx.CLASS_EFFECTS, 66, 44, 6, 6)
            ];
        
        public function TEffectDebris(origin:VOCoord, particles:uint, duration:uint, speed:uint){
