package net.retrocade.camel.core{
    ...
    public class rSave{
        ...
        public static function setStorage(storageName:String = null):void{
            sharedObject = SharedObject.getLocal(storageName || rCore._settings.SAVE_STORAGE_NAME, "/");
        }
         ...
         */
        public static function save(dataName:String, data:*, useEncryption:Boolean = true):void{
         ...
         */
        public static function load(dataName:String, def:*, useEncryption:Boolean = true):*{
