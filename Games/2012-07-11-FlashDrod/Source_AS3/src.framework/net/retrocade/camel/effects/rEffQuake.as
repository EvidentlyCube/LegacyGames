package net.retrocade.camel.effects{
    ...
    public class rEffQuake extends rEffectScreen{
        ...
        public function rEffQuake(duration:int, hPower:Number = 50, vPower:Number = 50, mode:uint = MODE_RANDOM, hSpeed:Number = 30, vSpeed:Number = 15, callback:Function = null){
            ...
            layer.graphics.drawRect(-hPower,          -vPower,                          rCore._settings.SIZE_GAME_WIDTH + 2 * hPower, vPower);
            layer.graphics.drawRect(-hPower,          rCore._settings.SIZE_GAME_HEIGHT, rCore._settings.SIZE_GAME_WIDTH + 2 * hPower, vPower);
            layer.graphics.drawRect(-hPower,          0,                                hPower,                                       rCore._settings.SIZE_GAME_HEIGHT);
            layer.graphics.drawRect(rCore._settings.SIZE_SWF_WIDTH, 0,                  hPower,                                       rCore._settings.SIZE_GAME_HEIGHT);
