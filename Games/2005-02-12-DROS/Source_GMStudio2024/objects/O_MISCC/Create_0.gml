if place_meeting(x+16,y,O_MISCC){r=1} else {r=0}
if place_meeting(x,y+16,O_MISCC){d=1} else {d=0}
if place_meeting(x-16,y,O_MISCC){l=1} else {l=0}
if place_meeting(x,y-16,O_MISCC){u=1} else {u=0}
