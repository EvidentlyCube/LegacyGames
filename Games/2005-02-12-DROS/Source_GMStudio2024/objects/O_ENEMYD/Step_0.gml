...
if global.turn=1{
	if global.clone=30{
	    if place_free(x   ,y-16) && !place_meeting(x   ,y-16,O_PLAYER){instance_create(x   ,y-16,O_ENEMYE)}
	    if place_free(x+16,y-16) && !place_meeting(x+16,y-16,O_PLAYER){instance_create(x+16,y-16,O_ENEMYE)}
	    if place_free(x+16,y   ) && !place_meeting(x+16,y   ,O_PLAYER){instance_create(x+16,y   ,O_ENEMYE)}
	    if place_free(x+16,y+16) && !place_meeting(x+16,y+16,O_PLAYER){instance_create(x+16,y+16,O_ENEMYE)}
	    if place_free(x   ,y+16) && !place_meeting(x   ,y+16,O_PLAYER){instance_create(x   ,y+16,O_ENEMYE)}
	    if place_free(x-16,y+16) && !place_meeting(x-16,y+16,O_PLAYER){instance_create(x-16,y+16,O_ENEMYE)}
	    if place_free(x-16,y   ) && !place_meeting(x-16,y   ,O_PLAYER){instance_create(x-16,y   ,O_ENEMYE)}
