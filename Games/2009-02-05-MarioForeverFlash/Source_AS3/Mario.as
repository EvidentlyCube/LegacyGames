...
package {
	...
	public class Mario extends Sprite{
		...
		private static var keysDown:Array=[false,false,false,false,false,false];
		private static var keysHit:Array=[0, 0, 0, 0, 0, 0];
		...
		public static function togglePause():void{
			if (sequence!=12 && sequence!=1 || musika==13){return;}
			if (pause==null){
				sequence=12;
				pause=new Pauser;
			} else {
