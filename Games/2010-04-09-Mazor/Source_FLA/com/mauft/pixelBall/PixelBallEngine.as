package com.mauft.pixelBall{
    import flash.display.DisplayObject;
    public class PixelBallEngine {
        public static var DEGtoRAD   :Number = 0.0174532925;
        
        public static var terrain    :DisplayObject;
        
        public static function updateObject(ball:IPixelBall, gravityX:Number, gravityY:Number):void {
            ...
            for (var j:int = 1; j <= ball.steps; j++) {
                ...
                ball.speedH += gravityX;
                ball.speedV += gravityY;
