package net.retrocade.camel.global{
    ...
    public class rSfx{
        ...
        retrocamel_int static function registerMusic(music:rSound):void{
            rSfxMusicManager.register(music);
        }

        retrocamel_int static function registerSound(sound:rSound):void{
            rSfxSoundManager.register(sound);
        }

        retrocamel_int static function unregister(sound:rSound):void{
...
class rSfxSoundManager{
    ...
    private static var _registeredSounds:Vector.<rSound> = new Vector.<rSound>();
	...
	retrocamel_int static function set volume(value:Number):void{
        ...
        for each(var sound:rSound in _registeredSounds){
    ...
    retrocamel_int static function register(sound:rSound):void{
