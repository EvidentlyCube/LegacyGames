package net.retrocade.standalone{
    ...
    public class Button extends rSprite{
        ...
        protected function addEventListeners(e:*):void{
            ...
            rDisplay.flashStage.addEventListener(MouseEvent.MOUSE_UP, onStageTouchEnd, false, 0, true);
        }
        ...
        protected function removeEventListeners(e:*):void{
            ...
            rDisplay.flashStage.removeEventListener(MouseEvent.MOUSE_UP, onStageTouchEnd);
        }
