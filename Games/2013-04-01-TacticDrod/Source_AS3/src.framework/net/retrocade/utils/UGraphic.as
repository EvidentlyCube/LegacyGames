package net.retrocade.utils {
    ...
    public class UGraphic {
         ...
         */
        private static var _instance:UGraphic = new UGraphic();

        /**
         * Starts drawing with given object
         * @param object Graphics object or any class which contains graphics parameter
         * @return UGraphic objct for chaining
         */
        public static function draw(object:*):UGraphic {
         ...
         * @return UGraphic objct for chaining
         */
        public static function clear(object:*):UGraphic {
         ...
         * @return Chain
         */
        public function rectFill(x:Number, y:Number, width:Number, height:Number, color:uint, alpha:Number = 1):UGraphic {
         ...
         * @return Chain
         */
        public function rectFillGradient(x:Number, y:Number, width:Number, height:Number, colors:Array, alphas:Array, ratios:Array, rotation:Number):UGraphic {
         ...
         * @return Chain
         */
        public function rectFillBitmap(x:Number, y:Number, width:Number, height:Number, bitmap:BitmapData, offsetX:Number, offsetY:Number):UGraphic {
            matrix.identity();
         ...
         * @return Chain
         */
        public function rectOutline(x:Number, y:Number, width:Number, height:Number, bold:Number, color:uint, alpha:Number = 1):UGraphic {
            graphics.beginFill(color, alpha);
         ...
         */
        public function beginBitmapFill(bitmap:BitmapData, matrix:Matrix = null, repeat:Boolean = true, smooth:Boolean = false):UGraphic {
         ...
         */
        public function beginBitmapFillSimple(bitmap:BitmapData, x:Number, y:Number, repeat:Boolean = true, smooth:Boolean = false):UGraphic {
            matrix.identity();
         ...
         */
        public function beginFill(color:uint, alpha:Number = 1.0):UGraphic {
            graphics.beginFill(color, alpha);
         ...
         */
        public function clear():UGraphic {
            graphics.clear();
         ...
         */
        public function copyFrom(sourceGraphics:Graphics):UGraphic {
         ...
         */
        public function curveTo(curveX:Number, curveY:Number, toX:Number, toY:Number):UGraphic {
         ...
         */
        public function drawCircle(x:Number, y:Number, radius:Number):UGraphic {
         ...
         */
        public function drawEllipse(x:Number, y:Number, width:Number, height:Number):UGraphic {
         ...
         */
        public function drawRect(x:Number, y:Number, width:Number, height:Number):UGraphic {
            graphics.drawRect(x, y, width, height);
         ...
         */
        public function drawRoundRect(x:Number, y:Number, width:Number, height:Number, ellipseWidth:Number, ellipseHeight:Number = NaN):UGraphic {
         ...
         */
        public function endFill():UGraphic {
            graphics.endFill();
         ...
         */
        public function lineBitmapStyle(bitmap:BitmapData, matrix:Matrix = null, repeat:Boolean = true, smooth:Boolean = false):UGraphic {
         ...
         * @copy flash.display.Graphics#lineBitmapStyle()
         */
        public function lineStyle(thickness:Number = NaN, color:uint = 0, alpha:Number = 1.0, pixelHinting:Boolean = false, scaleMode:String = "normal", caps:String = null, joints:String = null, miterLimit:Number = 3):UGraphic {
         ...
         */
        public function lineTo(x:Number, y:Number):UGraphic {
            graphics.lineTo(x, y);
         ...
         */
        public function moveTo(x:Number, y:Number):UGraphic {
            graphics.moveTo(x, y);
