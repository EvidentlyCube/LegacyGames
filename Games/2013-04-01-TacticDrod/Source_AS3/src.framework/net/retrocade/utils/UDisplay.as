package net.retrocade.utils{
    ...
    public class UDisplay{
         ...
         */
        public static function calculateScale(currentWidth:Number, currentHeight:Number, targetWidth:Number, targetHeight:Number, scaleMode:String = SHOW_ALL):void{
            switch(scaleMode){
                case(EXACT_FIT):
         ...
         * @param scaleMode Scale mode, constants are defined in StageScaleMode
         */
        public static function calculateScaleObject(displayObject:DisplayObject, targetWidth:Number, targetHeight:Number, scaleMode:String = SHOW_ALL):void{
            calculateScale(displayObject.width / displayObject.scaleX, displayObject.height / displayObject.scaleY, targetWidth, targetHeight, scaleMode);
        }
         ...
         * @param scaleMode Scale mode, constants are defined in StageScaleMode
         */
        public static function scaleDisplayObject(scaledObject:DisplayObject, targetWidth:Number, targetHeight:Number, scaleMode:String = SHOW_ALL):void{
         ...
         * @param scaleMode Scale mode, constants are defined in StageScaleMode
         */
        public static function scaleDisplayObjectDown(scaledObject:DisplayObject, targetWidth:Number, targetHeight:Number, scaleMode:String = SHOW_ALL):void{
            calculateScaleObject(scaledObject, targetWidth, targetHeight, scaleMode);
         ...
         */
        public static function columnify(items:Array, space:Number = 0, minWidth:Number = 0, offsetX:Number = 0, offsetY:Number = 0):Number {
        ...
        public static function removeMulti(parent:DisplayObjectContainer, ...rest):void {
            for each(var i:* in rest) {
                ...
                else (i is DisplayObject && parent.contains(i));
         ...
         */
        public static function wrapInSprite(displayObject:DisplayObject):rSprite{
            var parent:DisplayObjectContainer = displayObject.parent;
            var sprite:rSprite                = new rSprite();
