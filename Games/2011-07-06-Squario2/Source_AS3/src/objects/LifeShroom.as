package objects
{
   ...
   public class LifeShroom extends Obj
   {
      ...
      public function LifeShroom(param1:uint, param2:uint)
      {
         SFX = new (Mario.classSFX.accessSFX("life"))();
         super();
         oX = param1;
         oY = param2;
         var _loc3_:Class = Mario.classGFX.AccessGFX("object_lifeshroom");
         GFX = new _loc3_();
         GFX.x = oX;
         GFX.y = oY;
      ...
      override public function Update(param1:uint) : void
      {
         ...
         else
         {
            ...
            if(Mario.levelColl(oX + 12,oY + 24) == false)
            {
               ...
               oX += 2;
               oY += 4;
               _loc2_ = Mario.classGFX.AccessGFX("object_lifeshroom");
               GFX = new _loc2_();
               GFX.x = oX - 2;
               GFX.y = oY - 4;
