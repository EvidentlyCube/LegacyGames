package objects
{
   ...
   public class BBeetle extends Enemy
   {
      ...
      public function BBeetle(param1:uint, param2:uint)
      {
         ...
         GFX[3] = GFX[1] = new (Mario.classGFX.AccessGFX("enemy_bbeetle_2"))();
         GFX[2] = new (Mario.classGFX.AccessGFX("enemy_bbeetle_3"))();
         GFX[0].x = eX - 2;
         GFX[0].y = eY - 4;
      ...
      override public function Fire(param1:uint, param2:int) : Boolean
      {
         ...
         alive = false;
         Mario.instEffects.push(new Enemy_Fire(eX - 2,eY - 2,Mario.Sign(param2) * 3,Mario.classGFX.AccessGFX("enemy_bbeetle_1")));
         return true;
      }
   }
}
