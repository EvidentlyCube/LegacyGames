package objects
{
   ...
   public class TroopaGreen extends Enemy
   {
      ...
      public function TroopaGreen(param1:uint, param2:uint)
      {
         GFX = new Array(4);
         ...
         GFX[1] = GFX[3] = new (Mario.classGFX.AccessGFX("enemy_koopa_green_2"))();
         GFX[2] = new (Mario.classGFX.AccessGFX("enemy_koopa_green_3"))();
      ...
      override public function Fire(param1:uint, param2:int) : Boolean
      {
         ...
         alive = false;
         Mario.instEffects.push(new Enemy_Fire(eX - 2,eY - 1,Mario.Sign(param2) * 3,Mario.classGFX.AccessGFX("enemy_koopa_green_1")));
         return true;
      }
   }
}
