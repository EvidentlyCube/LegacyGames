package objects
{
   ...
   public class FlyGreen extends Enemy
   {
      ...
      public function FlyGreen(param1:uint, param2:uint)
      {
         GFX = new Array(3);
         ...
         GFX[2] = new (Mario.classGFX.AccessGFX("enemy_fly_green_3"))();
         GFX[0].x = eX - 3;
         GFX[0].y = eY - 5;
      ...
      override public function Fire(param1:uint, param2:int) : Boolean
      {
         ...
         alive = false;
         Mario.instEffects.push(new Enemy_Fire(eX - 2,eY - 1,Mario.Sign(param2) * 3,Mario.classGFX.AccessGFX("enemy_fly_green_1")));
         return true;
      }
