package net.retrocade.standalone{
    ...
    public class Text extends rSprite {
        ...
        public function Text(text:String = '', font:String = 'Pixelade', size:Number = 13, color:uint = 0xFFFFFF) {
            super()
        ...
        public function setTextCaps(text:String, sizeBig:int, sizeSmall:int):void{
            var htmlText:String = '<font size="'+sizeBig+'">'+text.charAt(0)+'</font><font size="'+(sizeSmall)+'">'+text.substr(1)+'</font>';
