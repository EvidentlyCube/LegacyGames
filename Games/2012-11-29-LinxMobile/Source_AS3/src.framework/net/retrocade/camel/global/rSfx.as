package net.retrocade.camel.global{
    ...
    public class rSfx{
		...
		/**
		 * Accesses the volume of souns, the one set in the options.
		 */
         ...
         */
        public static function set musicFadeVolume(value:Number):void{
         ...
         * @private
         */
		public static function get musicFadeVolume():Number{
		...
		public static function playSound(sound:*):void{
			if (sound is Sound == false)
				sound = getS(sound);

			rSfxSoundManager.play(sound);
		}
...
class rSfxSoundManager{
	...
	retrocamel_int static function set volume(value:Number):void{
		...
		for each(var sound:SoundChannel in _playingSounds){
			if (sound)
				sound.soundTransform = _soundTransform;
		}
	}
	...
	retrocamel_int static function play(sfx:Sound):void{
		var soundChannel:SoundChannel = sfx.play(100, 0, _soundTransform);
