package net.retrocade.camel.animations{
    ...
    public class rAnimPixelBug extends rObject{
        ...
        public function rAnimPixelBug(layerToDraw:rLayerBlit, edgeRight:int, edgeBottom:int, spd:Number, colorLight:uint = 0xFFAAAAAA, colorDark:uint = 0xFF222222){
            _layer      = layerToDraw;
