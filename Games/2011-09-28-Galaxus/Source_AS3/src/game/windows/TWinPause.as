package game.windows {
	...
	public class TWinPause extends RetrocamelWindowFlash {
		...
		public function TWinPause() {
			...
			if (RetrocamelSimpleSave.read("useMouseControls", true) == true)
		...
		private function onControlMouse():void {
			...
			RetrocamelSimpleSave.write('useMouseControls', true);
		}
		...
		private function onControlKeys():void {
			...
			RetrocamelSimpleSave.write('useMouseControls', false);
		}
	}
}