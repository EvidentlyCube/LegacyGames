package net.retrocade.standalone {
    ...
    public class Bitext extends Bitmap {
        /****************************************************************************************************************/
        /**                                                                                                  CONSTANTS  */
        /****************************************************************************************************************/
         ...
         */
        retrocamel_int var _font:BitextFont
         ...
         */
        public function Bitext(text:String = "", font:BitextFont = null, enableCaching:Boolean = false) {
            if (font == null)
                _font = BitextFont.defaultFont;
            else
                _font = font;
         ...
         */
        public function forceRedraw(full: Boolean = false):void{
            if (full) {
                _needFullRedraw = true;
            }
        ...
        public function positionToCenterScreen():void{
            x = (rCore.settings.gameWidth - width) / 2 | 0;
        }
        ...
        public function positionToMiddleScreen():void {
            y = (rCore.settings.gameHeight - height) / 2 | 0;
        }
