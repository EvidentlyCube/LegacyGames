package net.retrocade.camel.layers{
    ...
    public class rLayerBlit extends rLayer{
        ...
        public function rLayerBlit(){
            _bitmapData = new BitmapData(rCore.settings.gameWidth, rCore.settings.gameHeight, true, 0x00000000);
        ...
        override public function clear():void {
            _rect.x      = 0;
            _rect.y      = 0;
            _rect.width  = rCore.settings.gameWidth;
            _rect.height = rCore.settings.gameHeight;
        ...
        /**
         * Blits a part of the given rectangle to the screen
         * @param source Source BitmapData
         * @param tileRect Rectangle designating the area of the Source which has to be drawn
         * @param x X position of the drawing
         * @param y Y position of the drawing
         */
        public function blitRect(source:BitmapData, tileRect:Rectangle, x:int, y:int):void{
            _point.x = x + scrollX;
            _point.y = y + scrollY;
