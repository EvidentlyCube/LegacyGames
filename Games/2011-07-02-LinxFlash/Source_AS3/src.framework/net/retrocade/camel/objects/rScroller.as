    ...
    public class rScroller extends rObject{
        ...
        override public function update():void{
            if (!locked && followingObject){
                to_x = followingObject.xMid - rCore.settings.levelWidth  / scrollScale / 2;
                to_y = followingObject.yMid - rCore.settings.levelHeight / scrollScale / 2;
            }
        ...
        public function setCorners(_l:Number, _t:Number, _r:Number, _b:Number):void{
            corner_left   = _l;
            corner_top    = _t;
            corner_right  = _r - rCore.settings.levelWidth;
            corner_bottom = _b - rCore.settings.levelHeight;
        }
        ...
        public function scrollTo(toX:Number, toY:Number):void{
            to_x = UNumber.limit(toX - rCore.settings.levelWidth / 2, corner_right, corner_left)
            to_y = UNumber.limit(toY - rCore.settings.levelHeight / 2, corner_bottom, corner_top);
        }
        ...
        public function get edgeRight ():Number{ return corner_right  + rCore.settings.levelWidth;;  }
        public function get edgeTop   ():Number{ return corner_top      }
        public function get edgeBottom():Number{ return corner_bottom + rCore.settings.levelHeight; }
    }
}