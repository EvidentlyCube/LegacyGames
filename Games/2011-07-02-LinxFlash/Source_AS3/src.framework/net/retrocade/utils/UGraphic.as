package net.retrocade.utils{
   ...
   public class UGraphic{
         ...
         * @copy flash.display.Graphics#lineBitmapStyle()
         */
        public function lineStyle(thickness:Number = NaN, color:uint = 0, alpha:Number = 1.0, pixelHinting:Boolean = false, scaleMode:String = "normal",
                                  caps:String = null, joints:String = null, miterLimit:Number = 3):UGraphic{
