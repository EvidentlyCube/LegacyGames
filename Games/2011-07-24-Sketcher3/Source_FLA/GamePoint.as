package{
    ...
    public class GamePoint extends MovieClip{
        ...
        private function kill():void{
            ...
            var self:GamePoint = this;
            eaze(body).to(1, {scaleX: 1, scaleY: 1, alpha: 0}, true).easing(Expo.easeOut).onComplete(function():void{
                Level.removePoint(self);
            });
            eaze(text).to(1, {alpha: 0}).easing(Expo.easeOut);
        ...
        public function wake():void{
            ...
            eaze(body).to(0.5, {scaleX: 0.3, scaleY: 0.3}).easing(Expo.easeOut);
            eaze(text).to(0.5, {alpha: 1}).easing(Expo.easeOut);
            visible = true;
