package{
    ...
    public class Level extends MovieClip{
        ...
        private function $sketch(startX:Number, startY:Number, startRad:Number, endX:Number, endY:Number, endRad:Number):void{
        ...
        private function $sketchCircle(x:Number, y:Number, rad:Number):void{
            _sketchMask.graphics.beginFill(0x000000);
        ...
        private function $removePoint(gp:GamePoint):void{
            if (_points && _points.contains(gp))
        ...
        public static function sketchCircle(x:Number, y:Number, rad:Number):void                             { if (currentLevel){ currentLevel.$sketchCircle(x, y, rad);                              } }
        public static function sketch(startX:Number, startY:Number, startRad:Number, endX:Number, endY:Number, endRad:Number):void{ if (currentLevel){ currentLevel.$sketch(startX, startY, startRad, endX, endY, endRad); } }
    }
}