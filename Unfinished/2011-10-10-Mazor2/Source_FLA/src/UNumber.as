package src{
    public class UNumber{
        ...
        /**
         * @private
         * Helper used by average function 
         */
        private static var _averageAdditionalElements:int = 0;
        
        /**
         * Counter used by unique function
         */
        ...
        /**
         * Find the biggest number of all the passed integers and array elements.
        ...
        /**
         * Find the smallest number of all the passed integers and array elements.
         * @return The smallest value from all of the passed
         */
        ...
        public static function randomXY(x:Number, y:Number, offset:Number = 1):Number{
            x += offset;
            y *= offset;
        ...
        /**
         * @private
         * Subofunction of average(), calculate value of ALL nested arrays
         */
