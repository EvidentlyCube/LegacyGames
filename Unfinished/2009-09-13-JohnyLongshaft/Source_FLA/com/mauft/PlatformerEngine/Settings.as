...
package com.mauft.PlatformerEngine{
	...
	final public class Settings{
		public static const SCREEN_WIDTH:uint=510					//Just type the game screen width here, it does not neccesirily have to be the size of flash app (but can't be bigger
		public static const SCREEN_HEIGHT:uint=420				//Just type the game screen height here, it does not neccesirily have to be the size of flash app (but can't be bigger
		
		public static const TILE_WIDTH:uint=30					//Width of one tile in pixels
		public static const TILE_HEIGHT:uint=30					//Height of one tile in pixels
		public static const LEVEL_WIDTH:uint=170					//Maximum level width in tiles, best if not too big for speed reasons
		public static const LEVEL_HEIGHT:uint=14					//Maximum level height in tiles, best if not too big for speed reasons
		
		public static const PLAYER_MAXSPEED:Number=2.5			//Player's maximum speed in PPS
		public static const PLAYER_ACCELERATION:Number=0.15		//Player's acceleration in PPS
		public static const PLAYER_FRICTION:Number=0.04			//Player's speed of breaking when not running in PPS
		public static const PLAYER_BRAKING:Number=0.1				//Player's speed of running when trying to quickly change direction (in other words, if you run right and start to hold left, how quickly will you brake) in PPS
		...
		public static const PLAYER_JUMP:Number=-2					//Player's vertical speed when jumping
		public static const PLAYER_JUMP_HOLD:uint=6				//When player holds the jump button after jumping, amount of steps he can "lenghten" the jump before gravity starts to work
		...
		public static const GRAVITY:Number=0.1					//Power of the gravity in PPS
		public static const PLAYER_GRAVITY:Number=0.1				//Power of the gravity for player in PPS
