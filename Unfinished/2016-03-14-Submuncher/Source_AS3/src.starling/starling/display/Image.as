...
package starling.display
{
    ...
    public class Image extends Quad {
        ...
        override public function clone():* {
            var clone:Image = new Image(mTexture);
            cloneSetProperties(clone, true);
        ...
        override protected function cloneSetProperties(clone:*, cloneChildren:Boolean):void {
            ...
            var c:Image = clone as Image;

            c.mTexture = mTexture;
            c.mSmoothing = mSmoothing;
            c.mVertexDataCache = mVertexDataCache.clone();
            c.mVertexDataCacheInvalid = mVertexDataCacheInvalid;
        }
    }
}