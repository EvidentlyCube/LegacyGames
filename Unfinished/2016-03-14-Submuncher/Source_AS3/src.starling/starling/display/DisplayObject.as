...
package starling.display
{
    ...
    public class DisplayObject extends EventDispatcher
    {
        ...
        public var usesEvents:Boolean = true;
        ...
        final public function alignCenter(offset:Number = 0):void {
            x = ((RetrocamelDisplayManager.starlingStage.stageWidth - width) / 2 | 0) + offset | 0;
        }
        ...
        final public function alignMiddle(offset:Number = 0):void {
            y = ((RetrocamelDisplayManager.starlingStage.stageHeight - height) / 2) + offset | 0;
        }
        ...
        public function clone():*{
            throw new Error("Display object cannot be cloned");
        }

        protected function cloneSetProperties(clone:*, cloneChildren:Boolean):void{
            var c:DisplayObject = clone as DisplayObject;
            ...
            c.mSkewX = mSkewX;
            c.mSkewY = mSkewY;
            c.mRotation = mRotation;
            c.mAlpha = mAlpha;
            c.mVisible = mVisible;
            c.mTouchable = mTouchable;
            c.mBlendMode = mBlendMode;
            c.mName = mName;
            c.mUseHandCursor = mUseHandCursor;
            c.mTransformationMatrix = mTransformationMatrix.clone();
            c.mOrientationChanged = mOrientationChanged;
            c.usesEvents = usesEvents;
        }
    }
}