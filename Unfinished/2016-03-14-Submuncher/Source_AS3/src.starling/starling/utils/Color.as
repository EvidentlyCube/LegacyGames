...
package starling.utils
{
    ...
    public class Color
    {
        ...
        public static function getMeanColor(current:uint, target:uint, factor:Number):uint{
            var currentRed:uint = getRed(current);
            var currentGreen:uint = getGreen(current);
            var currentBlue:uint = getBlue(current);
            var targetRed:uint = getRed(target);
            ...
            currentRed = currentRed + (targetRed - currentRed) * factor;
            currentGreen = currentGreen + (targetGreen - currentGreen) * factor;
            currentBlue = currentBlue + (targetBlue - currentBlue) * factor;
