package net.retrocade.retrocamel.particles {
    ...
    public class RetrocamelAnimEffectPixelBug extends RetrocamelUpdatableObject{
        ...
        public function RetrocamelAnimEffectPixelBug(layerToDraw:RetrocamelLayerFlashBlit, edgeRight:int, edgeBottom:int, spd:Number, colorLight:uint = 0xFFAAAAAA, colorDark:uint = 0xFF222222){
            _layer      = layerToDraw;
