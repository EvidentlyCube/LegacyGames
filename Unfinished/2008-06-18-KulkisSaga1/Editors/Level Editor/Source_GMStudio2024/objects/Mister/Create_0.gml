global.testo=get_open_filename("Kulkis Saga I Level File|*.kil","H:\\Projects\\Workon\\Kulkis Saga 1")
global.file=file_bin_open(global.testo,2)
...
for(y=0;y<29;y+=1){
    for(x=0;x<32;x+=1){
        ...
        ds_list_add(list_a,file_bin_read_byte(global.file))
        file_bin_seek(global.file,koko+928+928+928+928)
        ds_list_add(list_b,file_bin_read_byte(global.file))
